...
<div class="container-fluid wrapper sigup_bg" data-barba="container" data-barba-namespace="signup">
    <div class="col-12 col-sm-10 col-md-8 col-lg-6 form_box morph">
        <h1 class="text-center mt-5">Sign Up</h1>
        <div class="container d-flex justify-content-center">
            <form id="signup_form" class="col-11 col-lg-10" method="post">
               <div class="row">
                    <input type="text" class="form-control mt-5" name="first_name" id="first_name" placeholder="First Name">
                    <input type="text" class="form-control mt-3" name="last_name" id="last_name" placeholder="Last Name">
                    ...
                    <button class="btn btn-primary col-6 mx-auto mt-5 d-block" id="signup">Sign Up</button>
